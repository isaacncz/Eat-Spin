      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div ref={textRef} className="order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-eatspin-peach rounded-full mb-6">
              <span className="w-2 h-2 bg-eatspin-orange rounded-full animate-pulse" />
              <span className="text-sm font-medium text-eatspin-orange">
