      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div ref={textRef} className="order-2 lg:order-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-2.5 px-4 py-2 sm:px-5 sm:py-2.5 bg-gradient-to-r from-eatspin-peach/80 to-eatspin-peach rounded-full mb-6 shadow-sm border border-eatspin-orange/20 max-w-full">
              ...
              <span className="text-xs sm:text-sm font-semibold text-eatspin-orange tracking-wide">
